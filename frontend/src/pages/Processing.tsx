        ...
        <section className="mt-8">
            <div className="p-6 rounded-3xl bg-white shadow-sm border border-slate-200">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-semibold tracking-tight">Analysing your image…</h2>
                </div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                    {import.meta.env.VITE_DEMO_MODE === 'true' ? "Simulating the analysis pipeline..." : "Running the model on the server..."}
                </p>
