                ...
                <div className="mt-4 grid md:grid-cols-2 gap-6 text-sm text-slate-700">
                    <div>
                        ...
                        <ul className="mt-2 list-disc pl-5 space-y-1">
                            <li>Support clinicians and students with concise, guideline-anchored CXR summaries.</li>
                            <li>Standardise first-line investigations and safety‑net advice for common thoracic findings.</li>
                            <li>Accelerate teaching via transparent citations.</li>
                        </ul>
                    ...
                    <div>
                        <h3 className="font-semibold">Warnings & Disclaimers</h3>
                        <ul className="mt-2 list-disc pl-5 space-y-1">
                            <li><strong>Decision support only:</strong> Not a diagnosis or a substitute for clinical judgement.</li>
                            <li><strong>Context matters:</strong> History, exam, labs, prior imaging change management.</li>
                            <li><strong>Urgent symptoms:</strong> Severe breathlessness, chest pain, haemoptysis, hypoxia → urgent care.</li>
                            <li><strong>Data protection:</strong> Use de-identified images only.</li>
                            <li><strong>Model limits:</strong> Performance varies with device type/positioning/quality.</li>
                        </ul>
                    </div>
                </div>
                <div className="mt-6">
